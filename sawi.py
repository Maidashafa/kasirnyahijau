import streamlit as st # buat bikin tampilan web app yang simpel
import pandas as pd # buat ngelola data tapi bentuknya tabel
import os # buat ngatur file sm folder 
import io # buat bikin file sementara kaya pdf
import sqlite3 # ini database ringan, untuk nyambung ke database SQLite
from datetime import datetime # untuk ngatur waktu dan tanggal
from fpdf import FPDF # buat bikin file pdf 
import tempfile

# Memperbaiki warning datetime adapter
def adapt_datetime(val): 
    return val.isoformat()
# (ini buat ngubah format datetime jadi data string ISO biar bisa disimpen di database)
